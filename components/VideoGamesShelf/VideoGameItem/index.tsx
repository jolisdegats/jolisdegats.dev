  ...
  return (
    <button
      ...
      style={{
        ...
        zIndex:
          [
            'rotating-while-taking-out',
            'unfocusing-rotate-and-translate',
            'centering'
          ].includes(animationPhase) && isFocused
            ? 20
            : index,
        transitionProperty: 'transform',
        transitionDuration:
          animationPhase === 'unfocusing-rotate-and-translate' ||
          animationPhase === 'translate-back-to-shelf'
            ? `${UNFOCUS_ROTATE_AND_TRANSLATE_DURATION}ms`
            : '0.4s',
        ...
        transform:
          isFocused &&
          (animationPhase === 'taking-out' ||
            animationPhase === 'rotating-while-taking-out')
    ...
    >
      ...
      >
        ...
        <div
          className="absolute top-0 left-0 w-full h-full"
          style={{
            backgroundImage: `url(${CoverOverlay.src})`,
            backgroundSize: '100% 100%',
            backgroundPosition: 'center',
            backgroundRepeat: 'no-repeat'
          }}
