...
import { useVideoGamesShelfInput } from '@/components/VideoGamesShelf/hooks/useVideoGamesShelfInput'
import { useVideoGamesAnimation } from '@/components/VideoGamesShelf/hooks/useVideoGamesAnimation'
import { VideoGameItem } from '@/components/VideoGamesShelf/VideoGameItem'
import { HintDisplay } from '@/components/VideoGamesShelf/HintDisplay'
import { VIDEOGAMES_DATA } from '@/components/VideoGamesShelf/videogamesData'
...
const getCenterTranslationX = (index: number): number => {
  ...
  const bookCenter =
    firstBookCenter + index * offsetPerBook + firstBookCenter / 2
...
const VideoGamesShelfContent = () => {
  ...
  const [animationPhase, setAnimationPhase] =
    useState<AnimationPhase>(IDLE_ANIMATION_PHASE)
  ...
  return (
    <>
      ...
      <div
        role="list"
        className="gap-0 justify-center w-full h-full absolute inset-0"
        style={{
          display: 'grid',
          gridAutoFlow: 'column',
