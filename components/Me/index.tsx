          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 h-full">
            <div className="text-white w-full lg:w-1/2 order-1 lg:order-1">
              ...
              <div className="text-sm">
                <p>
                  I&apos;ve been hooked on technology ever since I got my first
                  computer at 4 (blame my parents!), and that passion never
                  faded.
                </p>
                <br />
                <p>
                  After spending years in marketing and strategy at startups, I
                  felt the pull towards a more concrete and technical form of
                  problem-solving. That&apos;s where web development came in!
                  This career switch enabled me to blend creativity with logic
                  as I explored frontend development and enjoyed some backend
                  challenges along the way.
                </p>
                <br />
                <p>
                  When I&apos;m not coding, you&apos;ll find me working on some
                  DIY projects, solving escape rooms, or binge-watching anime. I
                  have a soft spot for pasta and French cuisine (but please note
                  that coriander is my sworn enemy).
                </p>
                <br />
